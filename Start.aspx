...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        api url&nbsp;
        <asp:TextBox ID="TextBoxUrl" runat="server" Width="724px">https://company.oktapreview.com/api/v1/authn</asp:TextBox>
        <br />
        <br />
        username
        ...
        <br />
        password
        <asp:TextBox ID="TextBox4" runat="server" TextMode="Password">1_Thousand!!!!!</asp:TextBox>
        <br />
        <br />
